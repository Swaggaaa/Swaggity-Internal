...
void tD3D::tD3DFunctions::DrawString(float X, float Y, std::string Text, D3DCOLOR TextColor, bool Outlined, D3DCOLOR OutlineColor, bool Centered)
{
    RECT Rect;
    Rect.top = Y;
    Rect.left = X;
    ...
    if (Outlined)
        {
            ...
            if (Centered)
                {
					pD3D.Font->DrawTextA(NULL, Text.c_str(), strlen(Text.c_str()), &OutlineRectTop, DT_CENTER | DT_NOCLIP, OutlineColor);
					pD3D.Font->DrawTextA(NULL, Text.c_str(), strlen(Text.c_str()), &OutlineRectLeft, DT_CENTER | DT_NOCLIP, OutlineColor);
					pD3D.Font->DrawTextA(NULL, Text.c_str(), strlen(Text.c_str()), &OutlineRectRight, DT_CENTER | DT_NOCLIP, OutlineColor);
					pD3D.Font->DrawTextA(NULL, Text.c_str(), strlen(Text.c_str()), &OutlineRectBottom, DT_CENTER | DT_NOCLIP, OutlineColor);
                }
            else
                {
                    pD3D.Font->DrawTextA(NULL, Text.c_str(), strlen(Text.c_str()), &OutlineRectTop, DT_NOCLIP, OutlineColor);
                    pD3D.Font->DrawTextA(NULL, Text.c_str(), strlen(Text.c_str()), &OutlineRectLeft, DT_NOCLIP, OutlineColor);
                    pD3D.Font->DrawTextA(NULL, Text.c_str(), strlen(Text.c_str()), &OutlineRectRight, DT_NOCLIP, OutlineColor);
                    pD3D.Font->DrawTextA(NULL, Text.c_str(), strlen(Text.c_str()), &OutlineRectBottom, DT_NOCLIP, OutlineColor);
                }
        }
    if (Centered)
        {
